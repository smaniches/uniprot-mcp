...
| 746 offline + 42 live integration tests (real counts via `pytest --collect-only` at v1.1.7). | `pytest --ignore=tests/integration -q` for the offline 746; `pytest --integration tests/integration` for the 42. |
